...
To make the upstream of [TensorCircuit](https://github.com/tencent-quantum-lab/tensorcircuit) more robust and survive the breaking API changes from Python to Jax, this fork version of TensorNetwork will be further maintained (still at very early development stage).
